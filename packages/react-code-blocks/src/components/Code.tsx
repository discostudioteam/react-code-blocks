...
export interface CodeProps {
  ...
  codeTagProps?: {};
  /** The language in which the code is written. [See L|{ANGUAGES.md](https://github.com/rajinwonderland/react-code-blocks/blob/master/LANGUAGES.md) */
  language: string;
   ...
   */
  highlight: string;
  lineProps?: (lineNumber: number, highlighted: boolean) => any;
}
...
export default class Code extends PureComponent<CodeProps, {}> {
  ...
  isHighlighted(lineNumber: number) {
  ...
  render() {
    ...
    return (
      <SyntaxHighlighter
        ...
        wrapLines={this.props.highlight.length > 0 || !!this.props.lineProps}
        ...
        lineProps={lineNumber =>
          this.props.lineProps
            ? this.props.lineProps(lineNumber, this.isHighlighted(lineNumber))
            : {
                style: {
